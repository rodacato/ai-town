...
export type Difficulty = 'normal' | 'dura' | 'cruel'

export const DIFFICULTIES: Difficulty[] = ['normal', 'dura', 'cruel']
...
export const DIFFICULTY: Record<Difficulty, DifficultyRules> = {
  ...
  dura: { label: 'Dura', hint: 'Golpes más seguidos y más duros, reservas al 70%, peor cosecha y grano más caro.', gap: [1, 3], boons: 0.15, reserves: 0.7, harvest: 0.85, harm: 1.25, rationCost: 4 },
